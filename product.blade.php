@section('content')
                                    ...
                                    <div class="__btn-grp mt-2 mb-3">
                                        ...
                                        @else
                                            <button
                                                ...
                                                style="background-color: #4af34a !important;border-color: green !important;color: black !important;">
                                ...
                                <div class="row">
                                    <div class="col-12 position-relative">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            @else
                                                <div class="__chat-seller-btn cursor-pointer"
                                                    id="{{ $product->added_by == 'seller' && ($seller_temporary_close || ($product->seller->shop->vacation_status && $current_date >= $seller_vacation_start_date && $current_date <= $seller_vacation_end_date)) ? '' : 'contact-seller' }}"
                                                    style="color:black;">
                                                    <svg width="14" height="14" viewBox="0 0 14 14"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span
                                                        style="color:black !important">{{ \App\CPU\translate('chat') }}</span>
                                                </div>
                                            @endif
                                                ...
                                                $product->added_by == 'seller' &&
                                                    ($seller_temporary_close ||
                                                        ($product->seller->shop->vacation_status &&
                                                            $current_date >= $seller_vacation_start_date &&
                                                            $current_date <= $seller_vacation_end_date)))
                                                <span class="chat-seller-info"
                                                    style="position: absolute; inset-inline-end: 24px; inset-block-start: -4px"
                                                    data-toggle="tooltip"
                                                    title="{{ \App\CPU\translate('this_shop_is_temporary_closed_or_on_vacation._You_cannot_add_product_to_cart_from_this_shop_for_now') }}">
                                                    <img src="{{ asset('/public/assets/front-end/img/info.png') }}"
                                                        alt="i">
                                                </span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-12 msg-option mt-2" id="msg-option">
                                        ...
                                        <form action="">
                                            ...
                                            <textarea shop-id="{{ $product->seller->shop->id }}" class="chatInputBox form-control" id="chatInputBox"
                                                rows="5"> </textarea>
                                    ...
                                    @php(
    $products_for_review = App\Model\Product::active()->where('added_by', $product->added_by)->where('user_id', $product->user_id)->withCount('reviews')->get(),
)
                                        ...
                                        <div>
                                            <a href="{{ route('shopView', [$product->seller->id]) }}"
                                                ...
                                                <button class="btn w-100 d-block text-center"
                                                    style="background: {{ $web_config['primary_color'] }};color:#000">
    ...
    $products_for_review = App\Model\Product::where('added_by', 'admin')->where('user_id', $product->user_id)->withCount('reviews')->get(),
                    ...
                    @php(
    $more_product_from_seller = App\Model\Product::active()->where('added_by', $product->added_by)->where('user_id', $product->user_id)->latest()->take(5)->get(),
)
                    <div class="px-3 py-3">
                    ...
                    <div>
                        @foreach ($more_product_from_seller as $item)
                            @include('web-views.partials.seller-products-product-details', [
                                'product' => $item,
                    ...
                    <div>
                        ...
                        @if ($category)
                            <a class="text-capitalize view-all-text"
                                style="color:black !important;{{ Session::get('direction') === 'rtl' ? 'margin-left:10px;' : 'margin-right: 8px;' }}"
